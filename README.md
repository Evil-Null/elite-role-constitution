...
Complete file/module map: 42 files across 4 layers (including `.github/workflows/integrity.yml` CI, the `agent/` deployment files, and the `skills/elite-role/` skill bundle). See `KIMI_PROTOCOL.md` E.
